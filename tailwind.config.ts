...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'premium': '0 8px 30px hsl(0 0% 0% / 0.5)',
        'glow': '0 0 40px hsl(168 76% 46% / 0.2)',
        'glow-intense': '0 0 60px hsl(168 76% 46% / 0.35)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      backgroundImage: {
        ...
        'gradient-premium': 'linear-gradient(135deg, hsl(168 76% 46%), hsl(180 70% 42%))',
      },
    },
  },
